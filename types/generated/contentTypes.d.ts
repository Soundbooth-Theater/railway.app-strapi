...
export interface ApiCastCast extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Cast: Schema.Attribute.Component<'shared.cast', true>
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
    locale: Schema.Attribute.String & Schema.Attribute.Private
...
export interface ApiGroupGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Buy_All_Price: Schema.Attribute.Decimal &
    ...
    Display_Buy_All: Schema.Attribute.Boolean
    Display_Options: Schema.Attribute.Component<'shared.display-options', false>
    Group_Status: Schema.Attribute.Component<'shared.status', false>
    Information: Schema.Attribute.Component<'shared.informations', false>
    ...
    Name: Schema.Attribute.String
    publishedAt: Schema.Attribute.DateTime
    series: Schema.Attribute.Relation<'oneToOne', 'api::series.series'>
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
  }
...
export interface ApiItemItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Item_Status: Schema.Attribute.Component<'shared.status', false>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::item.item'> &
      Schema.Attribute.Private
    Name: Schema.Attribute.String & Schema.Attribute.Required
    Primary_color: Schema.Attribute.Integer
    publishedAt: Schema.Attribute.DateTime
    Sample_URL: Schema.Attribute.Media<'audios'>
    series: Schema.Attribute.Relation<'oneToOne', 'api::series.series'>
    Store: Schema.Attribute.Component<'shared.store', false>
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
    Visibilities: Schema.Attribute.Component<'shared.visibilities', false>
  }
}
...
export interface ApiSeriesSeries extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cast: Schema.Attribute.Relation<'oneToOne', 'api::cast.cast'>
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
    Description: Schema.Attribute.RichText
    ...
    Informations: Schema.Attribute.Component<'shared.informations', false>
    ...
    > &
      Schema.Attribute.Private
    Name: Schema.Attribute.String & Schema.Attribute.Required
    Parental_Control: Schema.Attribute.Component<
      'shared.parental-control',
      false
    >
    Primary_Color: Schema.Attribute.Integer
    publishedAt: Schema.Attribute.DateTime
    Sample_URL: Schema.Attribute.Media<'audios'>
    Series_Status: Schema.Attribute.Component<'shared.status', false>
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private
  }
